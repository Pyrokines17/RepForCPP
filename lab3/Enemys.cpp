...
Enemy::Enemy(int weight, int height, int hp, steady_clock_t last_time, int weightOfBorder, int heightOfBorder) :
        weight(weight), height(height), healthPoints(hp), gamePoints(25),
